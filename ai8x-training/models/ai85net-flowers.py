...
###################################################################################################
"""
Flower species classification network for AI85
"""
from torch import nn
import ai8x


class AI85FlowerNet(nn.Module):
    """
    Define CNN model for flower species classification.
    """
...
def ai85flowernet(pretrained=False, **kwargs):
    """
    Constructs an AI85FlowerNet model.
    """
    assert not pretrained
    return AI85FlowerNet(**kwargs)
